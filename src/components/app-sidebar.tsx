...
const navItems: Array<{ view: ViewType; label: string; icon: React.ReactNode; section?: string; minLevel?: number }> = [
  ...
  { view: 'fix-report', label: 'Fix Report', icon: <FileText className="h-5 w-5" />, section: 'management', minLevel: 2 },
      ...
      <div className="flex h-16 items-center justify-between border-b border-border px-4">
        {sidebarOpen && (
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-sm font-bold text-sidebar-foreground">Denials Doctor</h1>
